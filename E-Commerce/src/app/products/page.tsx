...
//   useEffect(() => {
//     filterProducts();
//   }, [searchText, selectedCategory, selectedRating, priceRange, products,filterProducts]);
//   useEffect(() => {
//   filterProducts();
// }, [filterProducts]); // No need for other dependencies like searchText, selectedCategory, etc. 
...
export default function ProductsPage() {
  ...
  // Call filterProducts whenever filter conditions change
  useEffect(() => {
    filterProducts();
  }, [filterProducts]);
